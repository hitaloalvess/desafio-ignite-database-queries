...
export class UsersRepository implements IUsersRepository {
  ...
  async findUserByFullName({
    ...
    return this.repository.query(`SELECT * FROM users AS u WHERE LOWER(u.first_name)=LOWER('${first_name}') AND LOWER(u.last_name)=LOWER('${last_name}')`); // Complete usando raw query
  }
}
